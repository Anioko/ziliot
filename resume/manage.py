...
def create_roles():
    ...
    db.session.add(Role(name='ROLE_COMPANY_BASIC', description='company basic'))
    db.session.add(Role(name='ROLE_COMPANY_SILVER', description='company silver'))
    db.session.add(Role(name='ROLE_COMPANY_GOLD', description='company gold'))
    db.session.add(Role(name='ROLE_COMPANY_PLATINUM', description='company platinum'))
